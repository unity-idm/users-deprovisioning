...
public class OnlineVerificatorTest
{
	...
	@Test
	public void shouldChangeUserStatusToAuthenticationDisabledWhenSAMLStatusAttrIsLocked() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "test",
						"http://test.pl")),
		...
		verify(groovyHook).runHook(eq(u1), eq(EntityState.authenticationDisabled), any(), any());
