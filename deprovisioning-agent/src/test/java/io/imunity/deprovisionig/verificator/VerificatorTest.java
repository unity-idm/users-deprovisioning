...
public class VerificatorTest
{
	...
	public void shouldGotoOnlineVerification() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "onlineProfile",
						"http://test.pl")),
	...
	@Test
	public void shouldGotoOnlineVerificationWhenOnlineAndOfflineIdentityAreAvailable() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "onlineProfile",
						"http://test.pl"),
						new Identity(Constans.IDENTIFIER_IDENTITY, "x2", "offlineOnly",
								"http://test2.pl")			
						),
				Set.of("/", "/A", "/B"), LocalDateTime.now().minusDays(8),
				LocalDateTime.now().minusDays(7), LocalDateTime.now().minusDays(8),
	...
	@Test
	public void shouldSkipOfflineVerificationIfOnlineIndentitiesAreVerified() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "onlineProfile",
						"http://test.pl"),
						new Identity(Constans.IDENTIFIER_IDENTITY, "x2", "onlineProfile",
								"http://test.pl")			
						),
				Set.of("/", "/A", "/B"), LocalDateTime.now().minusDays(8),
				LocalDateTime.now().minusDays(7), LocalDateTime.now().minusDays(8),
	...
	@Test
	public void shouldSkipUserIfIdentitiesComeFromDiffrentIDPs() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "onlineProfile",
						"http://test.pl"),
	...
	@Test
	public void shouldOnlyOfflineVerification() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "offlineOnly",
						"http://test.pl")),
				Set.of("/", "/A", "/B"), LocalDateTime.now().minusDays(8),
				LocalDateTime.now().minusDays(7), LocalDateTime.now().minusDays(8),
				LocalDateTime.now().minusDays(4), LocalDateTime.now().minusDays(1));
	...
	@Test
	public void shouldGoToOfflineVerificationWhenIdpIsNotInMeta() throws Exception
	{
		UnityUser u1 = new UnityUser(1L, "u1", EntityState.disabled,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x1", "onlineProfile",
						"http://test.pl")),
	...
	public void shouldDisableUserAfterOfflinePeriod() throws Exception
	{
		...
		UnityUser u2 = new UnityUser(2L, "u2", EntityState.valid,
				Arrays.asList(new Identity(Constans.IDENTIFIER_IDENTITY, "x2", "onlineProfile",
						"http://test.pl")),
